function calc() {
    ...
    document.getElementById("Final").style = "max-width: 25rem; margin: auto; border: 4px solid black; width: 50%; margin-top: 45px; background-color:white; border-radius: 20px; color:black; margin-bottom: 30px"
}